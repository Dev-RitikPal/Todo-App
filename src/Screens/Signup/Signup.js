  ...
  const handlesignup = async (e) => {
    ...
    try {
      const data = {
        ...
        // State: StateList[formData.States.value - 1]?.name,
    ...
    switch (key) {
      case "Name":
        setFormData({
          ...
          [key]: {
            value: value,
            errorMessage: handleValiDation("Name", value)
              ? "Name should longer"
              : "",
          },
        });
      ...
      case "Email":
        setFormData({
          ...
          [key]: {
            value: value,
            errorMessage: isEmailValid(value) ? " invalid Email" : "",
          },
        });
        return value.length < 2;
      case "Password":
        setFormData({
          ...
          [key]: {
            value: value,
            errorMessage: handleValiDation("Password", value)
      ...
      case "Phone":
        setFormData({
          ...
          [key]: {
            value: value,
            errorMessage: handleValiDation("Phone", value)
      ...
      case "Address":
        setFormData({
          ...
          [key]: {
            value: value,
            errorMessage: handleValiDation("Address", value)
              ? "Address should be up 10 character"
              : "",
          },
        });
        return value.length < 2;
      case "Country":
        setFormData({
          ...
          [key]: {
            value: value,
            errorMessage: handleValiDation("Country", value)
      ...
      case "States":
        setFormData({
          ...
          [key]: {
            value: value,
            errorMessage: handleValiDation("States", value)
              ? "State not selected"
              : "",
          },
        });
      ...
      case "City":
        setFormData({
          ...
          [key]: {
            value: value,
            errorMessage: handleValiDation("City", value)
              ? "City not selected"
              : "",
          },
        });
      ...
      case "Zipcode":
        setFormData({
          ...
          [key]: {
            value: value,
            errorMessage: handleValiDation("Zipcode", value)
              ? "Should be longer then 2 char"
              : "",
          },
        });
        return value.length < 2;
        ...
        <div className="signup-div">
          ...
          <center>
            {profilephoto ? (
              ...
              <img
                src="https://img.icons8.com/officel/150/000000/test-account.png"
                alt="profile"
                className="profilePhoto"
              />
            )}
          ...
          <form onSubmit={(e) => handlesignup(e)} method="POST">
            ...
            <input
              ...
              value={formData.Name.value}
              onChange={(e) => {
                handleChange("Name", e.target.value, formData, setFormData);
              }}
            />
            <span style={{ color: "red" }}>{formData.Name.errorMessage}</span>
            <br />
            ...
            <input
              ...
              onChange={(e) => {
                handleChange("Email", e.target.value, formData, setFormData);
              }}
            />
            <span style={{ color: "red" }}>{formData.Email.errorMessage}</span>
            <br />
            ...
            <input
              ...
              onChange={(e) => {
                handleChange("Password", e.target.value, formData, setFormData);
              }}
            />
            ...
            <input
              ...
              onChange={(e) => {
                handleChange("Phone", e.target.value, formData, setFormData);
              }}
            />
            <span style={{ color: "red" }}>{formData.Phone.errorMessage}</span>
            <br />
            ...
            <input
              ...
              onChange={(e) => {
                handleChange("Address", e.target.value, formData, setFormData);
              }}
            />
            <span style={{ color: "red" }}>
            ...
            />
            <br />
            <span style={{ color: "red" }}>{formData.States.errorMessage}</span>
            ...
            />
            <br />
            <span style={{ color: "red" }}>{formData.City.errorMessage}</span>
            ...
            <input
              ...
              onChange={(e) => {
                handleChange("Zipcode", e.target.value, formData, setFormData);
              }}
            />
            <span style={{ color: "red" }}>
              {formData.Zipcode.errorMessage}
            </span>
            <br />
            ...
            <button
              ...
              style={{ float: "left", marginLeft: "45%" }}
            >
